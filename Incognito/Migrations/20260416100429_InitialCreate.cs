...
namespace IncognitoPAS.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicalStack = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupervisorMatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupervisorMatches_AspNetUsers_SupervisorId",
                        column: x => x.SupervisorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupervisorMatches_Proposals_ProposalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupervisorMatches_ProposalId_SupervisorId",
                table: "SupervisorMatches",
                columns: new[] { "ProposalId", "SupervisorId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SupervisorMatches_SupervisorId",
                table: "SupervisorMatches",
                column: "SupervisorId");
        }
